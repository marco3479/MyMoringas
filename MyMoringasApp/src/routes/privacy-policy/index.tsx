...
export default component$(() => {
    return (
        <div class='p-10 px-32'>
            <h1 class='text-3xl font-semibold'>myMoringas LLC Privacy Policy</h1>
            <br/>
            <br/>
            <p>
                This Privacy Policy describes how your personal information is collected,
                used, and shared when you visit or make a purchase from http://myMoringas.com
                (the “Site”).
            </p> 
            <br/> 
            <br/> 
            <h2 className="text-2xl">PERSONAL INFORMATION WE COLLECT</h2>
            <br/>
            <p>
                ...
                are data files that are placed on your device or computer and often include
                an anonymous unique identifier. For more information about cookies, and how to
                disable cookies, visit http://www.allaboutcookies.org. - “Log files” track actions
                ...
                <br/>
                Like Google Analytics and Facebook Pixels. Additionally, when you make a
                purchase or attempt to make a purchase through the Site, we collect certain
            ...
            <h2 className="text-2xl">HOW DO WE USE YOUR PERSONAL INFORMATION?</h2>
            We use the Order Information that we collect generally to fulfill any orders 
            placed through the Site (including processing your payment information, arranging 
            for shipping, and providing you with invoices and/or order confirmations). 
            <br/>
            <p>
                ...
                fraud (in particular, your IP address), and more generally to improve and
                optimize our Site (for example, by generating analytics about how our customers
                 browse and interact with the Site, and to assess the success of our marketing
                 and advertising campaigns).
            <br/>
                Also, we use the same information for remarketing, this means you will see
                more advertising of us post-purchase, like Google Ads, Facebook Ads, and
                 Email Marketing.
            </p>
            <br/>
            <h2 className="text-2xl">SHARING YOUR PERSONAL INFORMATION</h2>
            ...
            power our online store--you can read more about how Shopify uses your Personal
            ...
            lawful requests for information we receive, or to otherwise protect our rights.

            <br/>
            <h2 className="text-2xl">BEHAVIOURAL ADVERTISING</h2>
            ...
            interest to you. For more information about how targeted advertising works,
             you can visit the Network Advertising Initiative’s (“NAI”) educational 
             page at http://www.networkadvertising.org/understanding- 
            ...
            <h2 className="text-2xl">DO NOT TRACK</h2>
            <p>    
            ...
            <p>
                ...
                (for example if you make an order through the Site), or otherwise to pursue
                our legitimate business interests listed above. Additionally, please note
                that your information will be transferred outside of Europe, including to
            ...
            <h2 className="text-2xl">MINORS</h2>
            ...
            <p>
                ...
                or if you would like to make a complaint, please contact us by e-mail at
                 info@myMooringas.com or by mail: 770 NE 2nd St, Lake Butler, FL 32054
            </p>
        </div>
    )
})